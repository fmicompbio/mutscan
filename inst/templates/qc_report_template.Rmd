...
mutscan::plotFiltering(params$se, valueType = "reads", onlyActiveFilters = TRUE, 
                       displayNumbers = TRUE, plotType = "remaining", facetBy = "sample")
```

```{r, fig.height = 1.5 * ncol(params$se), fig.width = 10}
mutscan::plotFiltering(params$se, valueType = "fractions", onlyActiveFilters = TRUE, 
...
```{r}
mutscan::plotTotals(params$se, selAssay = "counts")
```
...
```{r, warning = FALSE}
mutscan::plotDistributions(params$se, selAssay = "counts", pseudoCount = 1,
