...
collapseDataFrame <- function(df, variableCollapseMaxDist, variableCollapseMinReads, variableCollapseMinRatio, umiCollapseMaxDist, verbose = FALSE) {
    .Call(`_mutscan_collapseDataFrame`, df, variableCollapseMaxDist, variableCollapseMinReads, variableCollapseMinRatio, umiCollapseMaxDist, verbose)
}
