...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type collapseToWTForward(collapseToWTForwardSEXP);
    Rcpp::traits::input_parameter< bool >::type collapseToWTReverse(collapseToWTReverseSEXP);
